...
void inputHandler::processInput(GLFWwindow *window) {
    ...
    if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS)
        globalApplication::camera.ProcessKeyboard(FORWARD, globalApplication::input.deltaTime);
    if (glfwGetKey(window, GLFW_KEY_S) == GLFW_PRESS)
        globalApplication::camera.ProcessKeyboard(BACKWARD, globalApplication::input.deltaTime);
    if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS)
        globalApplication::camera.ProcessKeyboard(LEFT, globalApplication::input.deltaTime);
    if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS)
        globalApplication::camera.ProcessKeyboard(RIGHT, globalApplication::input.deltaTime);
    if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS)
        globalApplication::camera.ProcessKeyboard(UP, globalApplication::input.deltaTime);
    if (glfwGetKey(window, GLFW_KEY_LEFT_CONTROL) == GLFW_PRESS)
        globalApplication::camera.ProcessKeyboard(DOWN, globalApplication::input.deltaTime);
}
